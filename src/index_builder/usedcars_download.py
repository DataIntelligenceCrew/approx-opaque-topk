"""
Download the Kaggle 'US Used Cars Dataset' into a target directory using kagglehub 0.2.9 API. 
...
def download_us_used_cars(target_dir: Path) -> Path:
    ...
    :param target_dir: Directory where usedcars.csv will be saved.
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Download the Kaggle US Used Cars Dataset into a target directory.")
    ...
    print(f"[UsedCars Downloader] Dataset saved to: {out_file}")
